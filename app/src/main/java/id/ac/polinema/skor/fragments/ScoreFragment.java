...
public class ScoreFragment extends Fragment {
	...
	public static final String HOME_REQUEST_KEY = "home_request_key";
	public static final String AWAY_REQUEST_KEY = "away_request_key";
	public static final String SCORER_KEY = "Score_Key";
